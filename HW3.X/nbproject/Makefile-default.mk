...
ProjectDir=/Users/ben/Documents/GitHub/ME433/HW3.X
ProjectName=HW3
ConfName=default
...
MP_LINKER_FILE_OPTION=,--script="../Hw2.X/NU32DIPbootloaded.ld"
# ------------------------------------------------------------------------------------
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/_ext/2143948546/nu32dip.o: ../Hw2.X/nu32dip.c  .generated_files/flags/default/52e3abb371b47a40c902f7b92013ea53fc5f0783 .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}/_ext/2143948546" 
	@${RM} ${OBJECTDIR}/_ext/2143948546/nu32dip.o.d 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/HW3.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    ../Hw2.X/NU32DIPbootloaded.ld
	@${MKDIR} ${DISTDIR} 
